...
namespace RS_7.Functions.GroundReaction
{
    public class N1Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            p.ground_c = sp[(int)SP.xi_c];
            p.ground_a = sp[(int)SP.xi_a];
    ...
    public class N2Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            return NxXi.calculate(p, out Deformations.defs[(int)DefParams.D2Xi], out Deformations.defs[(int)DefParams.D2Xi_S]);
        }
    }
    ...
    public class N3Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            return NxXi.calculate(p, out Deformations.defs[(int)DefParams.D3Xi], out Deformations.defs[(int)DefParams.D3Xi_S]);
        }
    }
    ...
    public class N4Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            return NxXi.calculate(p, out Deformations.defs[(int)DefParams.D4Xi], out Deformations.defs[(int)DefParams.D4Xi_S]);
        }
    }
    ...
    public class N5Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            return NxXi.calculate(p, out Deformations.defs[(int)DefParams.D5Xi], out Deformations.defs[(int)DefParams.D5Xi_S]);
        }
    }
    ...
    public class N6Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            return NxXi.calculate(p, out Deformations.defs[(int)DefParams.D6Xi], out Deformations.defs[(int)DefParams.D6Xi_S]);
        }
    }
    ...
    public class N7Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            return NxXi.calculate(p, out Deformations.defs[(int)DefParams.D7Xi], out Deformations.defs[(int)DefParams.D7Xi_S]);
        }
    }
    ...
    public class N8Xi
    {
        public static double calculate(IList<double> dp, IList<double> sp)
        {
            ...
            return NxXi.calculate(p, out Deformations.defs[(int)DefParams.D8Xi], out Deformations.defs[(int)DefParams.D8Xi_S]);
        }
    }
}
